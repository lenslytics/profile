...
define("SMTP_EMAIL", "niazifallout222@gmail.com");
define("SMTP_PASSWORD", "beoxitmmloxouezm"); // read documentations


// Define Recipent Info ||  Who will get this email?
define("RECIPIENT_NAME", "Tayyab");
define("RECIPIENT_EMAIL", "tayyabniazi222@mail.com");
...
try {
    ...
    $firm    = isset($_POST['firm']) ? htmlspecialchars($_POST['firm']) : "";
    ...
    $mail->Body .= "<b>Email:</b> $senderEmail <br>";
    $mail->Body .= "<b>Phone:</b> $phone <br>";
    $mail->Body .= "<b>City:</b> $city <br>";
    $mail->Body .= "<b>Firm Name:</b> $firm <br>";
    $mail->Body .= "<b>Query:</b> <br>" . nl2br($subject) . "<br>";
